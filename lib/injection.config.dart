...
import 'package:harry_poter_app/application/characters/characters_cubit.dart'
    as _i4;
import 'package:harry_poter_app/application/hause/hause_cubit.dart' as _i5;
import 'package:harry_poter_app/application/spells/spells_cubit.dart' as _i10;
import 'package:harry_poter_app/domain/interface/i_characters_service.dart'
    as _i6;
import 'package:harry_poter_app/domain/interface/i_spells_service.dart' as _i8;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i5.HauseCubit>(() => _i5.HauseCubit(gh<String>()));
    gh.lazySingleton<_i6.ICharactersService>(() => _i7.CharactersService());
    gh.lazySingleton<_i8.ISpellsService>(() => _i9.SpellsService());
    gh.lazySingleton<_i10.SpellsCubit>(() => _i10.SpellsCubit());
    return this;
  }
}
